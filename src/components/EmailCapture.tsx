  ...
  return (
    <div className="relative z-10 flex min-h-[calc(100vh-72px)] flex-col items-center justify-center px-6 py-12 pb-20">
      <div className="relative z-10 w-full max-w-[540px] animate-[fadeUp_0.5s_ease_both] text-center">
        ...
        <h2 className="mb-5 font-['Barlow_Condensed'] text-[clamp(44px,6vw,68px)] font-black leading-[0.96] uppercase">
          One last
          <br />
          thing.
        </h2>
        ...
        <div className="mb-7 border border-divider border-l-[3px] border-l-amber bg-ink-2 p-6 text-left">
          <span className="mb-2.5 block font-['Barlow_Condensed'] text-[11px] font-bold uppercase tracking-[0.14em] text-amber">
            Score preview
          </span>
          {CATS.map((cat, i) => (
        ...
        <div className="mb-3 text-left">
          <label htmlFor="nameInput" className="mb-1.5 block font-['Barlow_Condensed'] text-xs font-bold uppercase tracking-[0.12em] text-grey">
            Full Name
          </label>
          <input
            id="nameInput"
        ...
        <div className="mb-4 text-left">
          <label htmlFor="emailInput" className="mb-1.5 block font-['Barlow_Condensed'] text-xs font-bold uppercase tracking-[0.12em] text-grey">
            Email Address
          </label>
          <input
            id="emailInput"
        ...
        <button
          ...
          className="w-full border-2 border-amber bg-amber px-9 py-4 font-['Barlow_Condensed'] text-[17px] font-extrabold uppercase tracking-[0.06em] text-ink transition-all hover:-translate-y-0.5 hover:bg-transparent hover:text-amber"
        >
          Show Me My Score →
        </button>
